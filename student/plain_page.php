...
while($ff=mysqli_fetch_array($ass))
{
	...
	?>  
		...
		<tr>
						<td><?php   echo $ff['firstname'];?></td>
					    <td> <?php   echo $ff['lastname'];?></td>
						 <td><?php   echo $ff['username'];?></td>
						 <td><?php   echo $ff['email'];	 ?>	</td>
						  <td><?php   echo $ff['contact'];?></td>
						   <td><?php   echo $ff['sem'];?></td>
						    <td> <?php   echo $ff['enrolment_no'];?></td>
