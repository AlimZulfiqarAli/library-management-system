...
<body class="login" style="margin-top: -20px;">
  ...
  <p class="change_link">If You Have Already Account?
...
if(isset($_POST['submit1']))
{
	...
	$sem=$_POST['sem'];
	$enrolmentno=$_POST['enrollmentno'];
	
	mysqli_query($con,"insert into stu_reg(firstname,lastname,username,password,email,contact,sem,enrolment_no)values('$firstname','$lastname','$username','$password','$email','$contact','$sem','$enrolmentno')");
