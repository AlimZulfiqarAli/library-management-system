...
$sdf=mysqli_query($con,"select * from message where stu_name='$_SESSION[users]'");
	
	
	while($sdfg=mysqli_fetch_array($sdf)){
		$sdfg['message'];
		$sdfg['date'];
				?>	   
				<tr>
					   <th>Dear <?php echo $_SESSION["users"]; ?></th>
					   </tr>
					   <tr>
					   <td><?php echo $sdfg['message'];?></td>
					   </tr>
					   <tr>
					   <td>Date <?php echo $sdfg['date'];?></td>
					   </tr>
