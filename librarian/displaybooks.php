...
$fg=mysqli_query($con,"select * from add_books");
	...
	$lib_user_name=$gk['lib_user_name'];
	 ...
	 ?>
							   ...
							   <tr>
							     ...
							     <td><?php echo "<img src='images/$lastname'width='100px'height='60px'>";?></td>
									   ...
									   <td><?php echo $contact; ?></td>
									    <td><?php echo $sem; ?></td>
										 <td><?php echo $enrolmentno; ?></td>
										  ...
										  <td><a href='delete.php?dele=<?php echo $id; ?>'><button  class='btn btn-danger btn-sm'>Delete</button></td>
